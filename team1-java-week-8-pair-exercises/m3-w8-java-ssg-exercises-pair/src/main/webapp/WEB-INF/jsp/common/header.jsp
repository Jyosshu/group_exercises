...
<body>
    ...
    <nav>
        ...
        <ul>
        	<c:url var="alienAgeLink" value="/alienAge" />
            <li><a href="${alienAgeLink}">Alien Age</a></li>
            
            <c:url var="alienWeightLink" value="/alienWeight" />
            <li><a href="${alienWeightLink}">Alien Weight</a></li>
            
            <c:url var="alienTravelLink" value="/alienTravel" />
            <li><a href="${alienTravelLink}">Drive Time</a></li>   
            
            <c:url var="spaceForumLink" value="/forum" />
            <li><a href="${spaceForumLink}">Space Forum</a></li>      
            
            <c:url var="spaceStoreLink" value="/shoppingCart/index" />
            <li><a href="${spaceStoreLink}">Space Store</a></li>       
        </ul>
    </nav>